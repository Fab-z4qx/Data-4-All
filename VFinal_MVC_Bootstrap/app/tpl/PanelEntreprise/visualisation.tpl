                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <button type="button" class="btn btn-info" onclick="self.location.href='entreprise.php?page=visualisation&action=getRawFile&value={$fileinfo[nom].nom}'" title="renommer"><i class="fa fa-edit"></i></button>
