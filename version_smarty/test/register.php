...
{
	extract($_POST);
	if( isset($email_entreprise) && isset($confemail_entreprise) && !empty($email_entreprise) && !empty($confemail_entreprise)) //Si les emails ne sont pas egaux
	{
		if(  $email_entreprise != $confemail_entreprise ){
