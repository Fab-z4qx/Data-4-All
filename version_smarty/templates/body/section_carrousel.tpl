	...
	<div id="myCarousel" class="carousel slide" data-interval="2000">
		<div class="carousel-inner">
			<div class="item active">
				<img src="images/carou1.png" />
			</div>
			<div class="item">
				<img src="images/carou2.png" />
			</div>
			<div class="item">
				<img src="images/carou3.png" />
			</div>
		</div>
		<div class="carousel-caption">
			<form class="form-search">
				<div class="form-group">
					<input type="search" class="input-sm " placeholder="Recherchez votre entreprise">
					<button type="submit" class="btn btn-primary btn-sm"></span> Chercher</button>
				</div>
			</form>
