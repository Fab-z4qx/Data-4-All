...
error_reporting(E_ERROR | E_PARSE);
	...
	function inser_css()
	{
		$CSS_TAB = array(   ROOT_TO_DIR.STYLE."style_index.css",
							...
							ROOT_TO_DIR.STYLE."panel_entreprise/changer_offre.css",
							ROOT_TO_DIR.STYLE."panel_entreprise/contact.css",
							ROOT_TO_DIR.STYLE."panel_entreprise/import_fichiers.css",
							ROOT_TO_DIR.STYLE."panel_entreprise/infos_compte.css",
							ROOT_TO_DIR.STYLE."panel_entreprise/stats_compte.css",
							ROOT_TO_DIR.STYLE."panel_entreprise/visualisation.css",
							ROOT_TO_DIR.STYLE."panel_entreprise/home_page.css",
							//ROOT_TO_DIR.STYLE."home_page/bootstrap.min.css"
							);
		return $CSS_TAB;
	}
